...
default: run_tests.x main_cg_poisson.x main_gmres_poisson_global.x main_polyg_poisson_global.x main_diagg_poisson_global.x main_gmres_poisson_cart.x main_polyg_poisson_cart.x main_diagg_poisson_cart.x main_gmres_poisson_win.x main_polyg_poisson_win.x main_diagg_poisson_win.x main_jacob_poisson_global.x main_jacob_poisson_cart.x main_jacob_poisson_win.x
...
gmres_solver.o: solver.hpp operations.hpp timer.hpp
polygmres_solver.o: solver.hpp operations.hpp timer.hpp
jacobi_solver.o: solver.hpp operations.hpp timer.hpp
cg_solver.o: solver.hpp operations.hpp timer.hpp
...
MAIN_CG_OBJ=main_poisson.cpp cg_solver.o operations.cpp timer.o 

MAIN_GMRES_OBJ=main_poisson.cpp gmres_solver.o operations.cpp timer.o 
MAIN_DIAGG_OBJ=main_poisson.cpp gmres_solver.o operations.cpp timer.o
MAIN_POLYG_OBJ=main_poisson.cpp polygmres_solver.o operations.cpp timer.o
MAIN_JACOB_OBJ=main_poisson.cpp jacobi_solver.o operations.cpp timer.o

MAIN_GMRES_CART_OBJ=main_poisson.cpp gmres_solver.o operations.cpp timer.o 
MAIN_DIAGG_CART_OBJ=main_poisson.cpp gmres_solver.o operations.cpp timer.o
MAIN_POLYG_CART_OBJ=main_poisson.cpp polygmres_solver.o operations.cpp timer.o
MAIN_JACOB_CART_OBJ=main_poisson.cpp jacobi_solver.o operations.cpp timer.o

MAIN_GMRES_WIN_OBJ=main_poisson.cpp gmres_solver.o operations.cpp timer.o 
MAIN_DIAGG_WIN_OBJ=main_poisson.cpp gmres_solver.o operations.cpp timer.o
MAIN_POLYG_WIN_OBJ=main_poisson.cpp polygmres_solver.o operations.cpp timer.o
MAIN_JACOB_WIN_OBJ=main_poisson.cpp jacobi_solver.o operations.cpp timer.o
...
main_cg_poisson.x: ${MAIN_CG_OBJ}
	${CXX} ${CXX_FLAGS} -DSTENCIL_GLOBAL_COMM -DUSE_CG -o main_cg_poisson.x $^
...
main_jacob_poisson_global.x: ${MAIN_JACOB_OBJ}
	${CXX} ${CXX_FLAGS} -DSTENCIL_GLOBAL_COMM -DUSE_JCOB -o main_jacob_poisson_global.x $^
...
main_jacob_poisson_cart.x: ${MAIN_JACOB_CART_OBJ}
	${CXX} ${CXX_FLAGS} -DSTENCIL_MPI_CART -DUSE_JCOB -o main_jacob_poisson_cart.x $^
...
main_jacob_poisson_win.x: ${MAIN_JACOB_WIN_OBJ}
	${CXX} ${CXX_FLAGS} -DSTENCIL_ONE_SIDED -DUSE_JCOB -o main_jacob_poisson_win.x $^
